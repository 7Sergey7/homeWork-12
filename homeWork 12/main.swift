...
oficeWorkerCondition = .inProcess(start: "12 : 35" , end: "13 : 55")

switch oficeWorkerCondition {
case .newlyCreated(let start, let end):
    print("worker start working`\(start), end working - \(end)")
case .inProcess(let start, let end):
    print("worker start working`\(start), end working - \(end)")
case .isChecked(let start, let end):
    print("worker start working`\(start), end working - \(end)")
